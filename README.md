...
Процент использования CPU может иметь значения: 20, 50 или 100:

![Использование CPU](./pix/1_Fractions.png)

Далее используем "20".

Количество используемых CPU cores может иметь значения: 2 или 4:
...
Параметры preemptible = true (отключаемая ВМ) и core_fraction=5 (минимальное использование CPU) позволят снизить затраты 
